...
import com.passengerapp.main.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// ========= Added By Vaishali ========================
	private scrollingDone listner = null;
	private int tag;

	public void setListner(int _tag, scrollingDone _listner) {
		tag = _tag;
		listner = _listner;
	}
	...
	private void doScroll(int delta) {
		...
		if (pos != currentItem) {
			...
			if (listner != null)
				listner.OnScrollingDone(tag, getCurrentItem());
